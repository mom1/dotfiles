# Generated by Powerlevel10k configuration wizard on 2019-08-25 at 01:43 MSK.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 20421.
...
() {
  ...
  function prompt_wifi_name() {
    if [[ $(networksetup -getairportnetwork en0 | cut -c 24-) == 'X5 Guest' ]]; then
      p10k segment -f 108 -t "$(networksetup -getairportnetwork en0 | cut -c 24-)"
    else
      p10k segment -f 208 -t "$(networksetup -getairportnetwork en0 | cut -c 24-)"
    fi
  }
}
